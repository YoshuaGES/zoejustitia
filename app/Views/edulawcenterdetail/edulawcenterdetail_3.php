            ...
            <div class="row g-5">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        ...
                        <h1 class="mb-4"><?php echo lang('Info.blog_3.title'); ?></h1>
                        <p><?php echo lang('Info.blog_3.content-1'); ?></p>
                        <p><?php echo lang('Info.blog_3.content-2'); ?></p>
                        <p><?php echo lang('Info.blog_3.content-3'); ?></p>
                    </div>
                    <!-- Blog Detail End -->
