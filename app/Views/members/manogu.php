                ...
                <div class="col-lg-7">
                        ...
                        <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                            <div class="team-item bg-light rounded overflow-hidden">
                                <div class="team-img position-relative overflow-hidden">
                                    <a href="teammember.html"><img class="img-fluid w-100" src="img/lawyermanogu.jpg" alt=""></a>
                                </div>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-12 wow slideInUp" data-wow-delay="0.3s">
                            ...
                            <!-- INDONESIA -->
                            <p class="mb-4"><?php echo lang('Info.manogu.content_1'); ?></p>
                            <p class="mb-4"><?php echo lang('Info.manogu.content_2'); ?>
                            </p>
                            <p class="mb-4"><?php echo lang('Info.manogu.content_3'); ?></p>
                            <p class="mb-4"><?php echo lang('Info.manogu.content_4'); ?></p>
                        </div>
                    </div>
                </div>
